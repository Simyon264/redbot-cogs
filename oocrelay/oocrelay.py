...
class Button(discord.ui.View):
    """Brings up the "add server" button."""
    # Taken from https://github.com/space-wizards/wizard-cogs/blob/master/poweractions/poweractions.py#L35
...
class Input(discord.ui.Modal, title='Input server details'):
    # Taken from https://github.com/space-wizards/wizard-cogs/blob/master/poweractions/poweractions.py#L17
